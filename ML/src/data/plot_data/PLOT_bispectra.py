...
def plot_triangle_space(gravity:str="gr",
                        seed:int=1234,
                        redshift:int=1,
                        k_res:int=25,
                        theta_res:int=25,
    ...
    df = pd.read_pickle('/mn/stornext/d10/data/johanmkr/simulations/data_analysis/bispectra_dataframes/bispectrum_gr_s0_z1_k25_t25_tag_test_with_new_geomspace.pkl')
