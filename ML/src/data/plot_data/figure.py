""" 
    This module contains the custom figure class for streamlining the plotting process.
"""
...
class CustomFigure:
    def __init__(self, 
                 ...
                 ncols:int=1, 
                 figsize:tuple=(10,10), 
                 settings:dict=None, *args, **kwargs) -> None:
...
def SaveShow(fig:plt.Figure|CustomFigure=None,
            save_name:str=None,
            save:bool=False,
            show:bool=False,
