...
#     comparison = Line2D(grdBk["k"], abs(grdBk["B"] - ndBk["B"]), color="black", label="Difference")
...
# average_equilateral_gr = pd.DataFrame({"k": np.geomspace(grBispectrum.kF, 1e-2, 1000), "B": np.zeros(1000), "Q": np.zeros(1000)})
# average_equilateral_newton = pd.DataFrame({"k": np.geomspace(grBispectrum.kF, 1e-2, 1000), "B": np.zeros(1000), "Q": np.zeros(1000)})
# average_squeezed_gr = pd.DataFrame({"k": np.geomspace(grBispectrum.kF, 1e-2, 1000), "B": np.zeros(1000), "Q": np.zeros(1000)})
# average_squeezed_newton = pd.DataFrame({"k": np.geomspace(grBispectrum.kF, 1e-2, 1000), "B": np.zeros(1000), "Q": np.zeros(1000)})
...
# comparison = Line2D(average_equilateral_gr["k"], abs(average_equilateral_gr["B"] - average_equilateral_newton["B"]), color="black", label="Difference")
...
# comparison = Line2D(average_squeezed_gr["k"], abs(average_squeezed_gr["B"] - average_squeezed_newton["B"]), color="black", label="Difference")
