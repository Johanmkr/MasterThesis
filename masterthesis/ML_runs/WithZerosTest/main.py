...
if __name__ == "__main__":
    ...
    # 1. make datasets
    train_data, test_data = tu.make_test_with_zeros_training_and_testing_data(
        **cfg.data_params
    )
    ...
    # 3. trainer
    test_name = f"RACCOON_test_with_zeros_lp{cfg.model_params['layer_param']}_lr{cfg.optimizer_params['lr']}"
    trainer = TRAINER(
        model=model,
    ...
    # PROFILER
    # trainer.run_profiler(
    #     **cfg.training_params,
    #     optimizer_params=cfg.optimizer_params,
    #     profiler_path=f"profiler/{test_name}",
    # )
