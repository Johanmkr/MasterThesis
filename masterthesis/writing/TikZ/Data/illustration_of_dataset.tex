...
\begin{tikzpicture}    
    ...
    % Large vertical curly brace
    \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt]
    (8,4) -- (8,-4) node [black,midway,xshift=1cm] 
    {Cube};
    \draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt]
    (8,-5) -- (8,-10) node [black,midway,xshift=1cm] 
    {Slice};


    % Layer/level texts

    \node (gravitytheory) at (-4, 3) {Gravity theory};
    \node (gravitytheory) at (-4, 0) {Redshift};
    \node (gravitytheory) at (-4, -3) {Seed};
    \node (gravitytheory) at (-4, -6) {Axis};
    \node (gravitytheory) at (-4, -9) {Slice};
