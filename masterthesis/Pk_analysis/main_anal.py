...
######################################################################################
train_bs = 256 * 3 * 2 * len(train_seeds)
test_bs = 256 * 3 * 2 * len(test_seeds)


train_data, test_data = datafile.create_data(train_seeds, test_seeds)
train_loader = DataLoader(train_data, batch_size=train_bs, shuffle=True, num_workers=workers, pin_memory=True)
test_loader = DataLoader(test_data, batch_size=test_bs, shuffle=False, num_workers=workers, pin_memory=True)
