...
# output file name
fout_S1 = 'S1_results.txt'
fout_S2 = 'S2_results.txt'
######################################################################################
...
S1_data = datafile.ScaledData(seeds=np.arange(200,250), train=False, mean=mean, variance=variance)
S2_data = datafile.ScaledData(seeds=np.arange(250,300), train=False, mean=mean, variance=variance)

S1_loader = DataLoader(S1_data, batch_size=256*3*2*50, shuffle=False, num_workers=24, pin_memory=True)
S2_loader = DataLoader(S2_data, batch_size=256*3*2*50, shuffle=False, num_workers=24, pin_memory=True)
