...
def locate_cube_and_calculate(seed, gravity, redshift, A_s):
    ...
    # Locate cube
    cube_path = datapath + f"{A_s}/seed{seed}/{gravity}/{gravity}_{redshift_to_snap[int(redshift)]}_phi.h5"
    ...
    if pl.Path(savepath).exists():
        ...
        print(f"Calculating and saving to {savepath}")
...
if __name__ == "__main__":
    ...
    A_s = [2.215e-9, 2.215e-8, 2.215e-7, 2.215e-6, 2.215e-5, 2.215e-4]
