...
B_avg_path = (
    lambda kind, A_s, gravity: avg_path
    + f"B_avg_{kind}_{A_s:.2e}_{gravity.lower()}.pkl"
)
...
def plot_equilateral_bispectrum(spectrum="equilateral"):
    ...
    newtdiff = main_ax.plot(
        *scaled_newton_data, ls="solid", color="blue", label="Newton"
    )
